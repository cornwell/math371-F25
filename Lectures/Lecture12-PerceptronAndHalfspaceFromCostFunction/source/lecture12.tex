...
\begin{frame}
    ...
    This is equivalent to wanting $y_i(\tilde{\bf x}_i^\top\tilde{\bf w}) \ge 1$ for all $i=1,\ldots,P$. Recall, $S$ being linearly separable implies that there must be a $\tilde{\bf w}$ that achieves this.
    \end{multicols}
\end{frame}
\section{Accuracy and Counting Costs}

\section{The Logistic Regression Cost}
