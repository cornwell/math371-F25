...
\frametitle{Difficulty in Defining the Problem}
    ...
    \begin{codeblock}
        \textcolor{mygreen}{Example.} A company wants to try to make a predictive model, using courses taken, types of work experience, other personal information, etc to predict how good a job candidate would be in a software developer role. ... %% or, the crime data
    \end{codeblock}
